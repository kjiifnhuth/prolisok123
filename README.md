# ЦРД «Пролісок» — сайт + CMS

GitHub-ready версія сайту ЦРД «Пролісок» з адаптивним frontend, Express API та простою JSON-базою для локального/невеликого self-hosted розгортання.
